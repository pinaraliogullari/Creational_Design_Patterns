...
//ASENKRON SÜREÇLER:Asenkron çalışma sonucunda 2 tane x nesnesi oluştu.Çünkü herhangi bir t zamanda birden fazla metot tarafından    _instances.TryTake(out T instance) ? instance : objectGenerator(); bu kontrol yapılıp false sonuç alınabilir dolayısıyla birden çok nesne oluşabilir. Amacımız süreç asenkron olsa da tek bir tane x nesnesi oluşması. Bunu sağlamak için  locklama yapıyoruz.
